![Qwiic PCA9685 - Python Package](docs/images/gh-banner.png "qwiic PCA9685 Python Package")
...
```sh
mpremote mip install --target "" github:sparkfun/qwiic_pca9685_py@examples
```
